...
els.openDisplay.addEventListener('click', () => {
  const win = window.open('display.html', 'roomDisplay', 'popup=yes,width=1920,height=1080');
  setTimeout(() => { try { win.document.documentElement.requestFullscreen(); } catch {} }, 600);
});
